...
public class CSpecimenMove extends AbsMetaController {

    @FXML
    private TextField txtSpecimenMovePrenation;

    @FXML
    private ComboBox<?> comboSpecimenMoveWorker;

    @FXML
    private Button btnSpecimenMoveChooseworker;
    ...
    @FXML
    private ComboBox<?> comboSpecimenMoveStatus;

    @FXML
    private ComboBox<?> comboSpecimenMoveLoc1;

    @FXML
    private ComboBox<?> comboSpecimenMoveLoc2;
    ...
    @FXML
    private ComboBox<?> comboSpecimenMoveLoc3type;
    ...
    @FXML
    private ComboBox<?> comboSpecimenMoveLoc2type;

    @FXML
    private ComboBox<?> comboSpecimenMoveLoc3;

    @FXML
    private Button btnSpecimenMoveCorrect;

    @FXML
    private TextField txtSpecimenMoveLabelID;
    ...
    @FXML
    private ComboBox<?> comboSpecimenMoveContent;
    ...
    @FXML
    void labelIDSpecimenMove(ActionEvent event) {
